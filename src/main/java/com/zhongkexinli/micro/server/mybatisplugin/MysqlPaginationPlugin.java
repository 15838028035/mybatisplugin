...
public class MysqlPaginationPlugin extends PluginAdapter {
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        genDelByPrimaryKeyElement(introspectedTable, parentElement);
    ...
    public boolean clientDeleteByPrimaryKeyMethodGenerated(Method method, Interface interfaze,
        ...
        newMethod.setName("delByPrimaryKey");
        newMethod.addParameter(new Parameter(new FullyQualifiedJavaType("java.lang.Integer"), "id"));
     ...
     * @return
     */
    public void genDelByPrimaryKeyElement(IntrospectedTable introspectedTable, XmlElement parentElement) {
        String tableName = introspectedTable.getTableConfiguration().getTableName();
        XmlElement updateElement = new XmlElement("update");
        context.getCommentGenerator().addComment(updateElement);
        updateElement.addAttribute(new Attribute("id", "delByPrimaryKey"));
        updateElement.addAttribute(new Attribute("parameterType", "java.lang.Integer"));
        updateElement.addElement(new TextElement("update " + tableName
                                                 + " set IS_DELETED = 1 where ID = #{id,jdbcType=INTEGER}"));
